...
from apps.controller import inception_controller
...
urlpatterns = [
    ...
    path('get_submit_sql_info/', inception_controller.get_submit_sql_info_controller),                                         # 页面获取所有工单列表
    path('get_apply_sql_by_uuid/', inception_controller.get_apply_sql_by_uuid_controller),                                     # 查看指定提交工单的详情
    ...
    path('submit_sql/', inception_controller.submit_sql_controller),                                                      # 提交SQL
    path('pass_submit_sql_by_uuid/', inception_controller.pass_submit_sql_by_uuid_controller),                            # 审核SQL
    ...
    path('get_master_ip/', inception_controller.get_master_ip_controller),                                                # sql审核--获取主库ip
    path('get_cluster_name/', inception_controller.get_cluster_name_controller),                                          # sql审核--根据cluster_name输入框自动补全

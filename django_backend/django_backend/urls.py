...
urlpatterns = [
    ...
    path('execute_submit_sql_by_file_path/', inception.execute_submit_sql_by_file_path_func),
    path('execute_submit_sql_by_file_path_manual/', inception.execute_submit_sql_by_file_path_manual_func),

...
MIDDLEWARE = [
    'utils.middleware.log_middleware.MyLogMiddleware',
    ...
    'utils.middleware.auth_middleware.MyAuthMiddleware',  # 自定义中间件登陆认证
]
...
LOGGING = {
    ...
    'filters': {
        ...
        'request_id': {
            '()': 'utils.middleware.log_middleware.TraceInfoFilter'
        }
    },
    # 处理器
    'handlers': {

...
urlpatterns = [
    ...
    path('get_view_sql_by_uuid/', audit_sql_controller.GetViewSqlByUuidController.as_view()), # 页面预览指定工单提交的SQL
    ...
    path('submit_recheck_sql/', audit_sql_controller.submit_recheck_sql_controller), # 重新提交SQL

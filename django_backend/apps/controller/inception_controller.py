...
def get_submit_sql_by_uuid_controller(request):
    ...
    ret = inception.get_submit_sql_by_uuid(submit_sql_uuid)
...
def get_apply_sql_by_uuid_controller(request):
    ...
    request_body = json.loads(to_str)
    submit_sql_uuid = request_body['params']['submit_sql_uuid']
    ret = inception.get_apply_sql_by_uuid(submit_sql_uuid)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def get_master_ip_controller(request):
    ...
    ret = inception.get_master_ip(db_master_ip_or_hostname)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def submit_sql_controller(request):
    ...
    to_str = str(request.body, encoding="utf-8")
    request_body = json.loads(to_str)
    ret = inception.submit_sql(token, request_body)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def get_submit_split_sql_by_file_path_controller(request):
    ...
    ret = inception.get_submit_split_sql_by_file_path(split_sql_file_path)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def get_inception_variable_config_info_controller(request):
    ...
    request_body = json.loads(to_str)
    split_sql_file_path = request_body['params']['split_sql_file_path']
    ret = inception.get_inception_variable_config_info(split_sql_file_path)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def update_inception_variable_controller(request):
    ...
    ret = inception.update_inception_variable(request_body_json,split_sql_file_path)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def get_check_sql_results_by_uuid_controller(request):
    ...
    request_body = json.loads(to_str)
    submit_sql_uuid = request_body['params']['submit_sql_uuid']
    ret = inception.get_check_sql_results_by_uuid(submit_sql_uuid)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def execute_submit_sql_by_file_path_controller(request):
    ...
    ret = inception.execute_submit_sql_by_file_path( submit_sql_uuid, inception_backup, inception_check_ignore_warning, inception_execute_ignore_error, split_sql_file_path,execute_user_name)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def execute_submit_sql_by_file_path_manual_controller(request):
    ...
    submit_sql_uuid = request_body['params']['submit_sql_uuid']
    split_sql_file_path = request_body['params']['split_sql_file_path']
    ret = inception.execute_submit_sql_by_file_path_manual(token,submit_sql_uuid,split_sql_file_path)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def get_execute_results_by_split_sql_file_path_controller(request):
    ...
    request_body = json.loads(to_str)
    split_sql_file_path = request_body['params']['split_sql_file_path']
    ret = inception.get_execute_results_by_split_sql_file_path(split_sql_file_path)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')
...
def get_execute_process_by_uuid_controller(request):
    ...
    request_body = json.loads(to_str)
    submit_sql_uuid = request_body['params']['submit_sql_uuid']
    ret = inception.get_execute_process_by_uuid(submit_sql_uuid)
    return HttpResponse(json.dumps(ret, default=str), content_type='application/json')

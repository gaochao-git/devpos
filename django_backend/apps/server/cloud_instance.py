...
def get_cloud_instance_func(request):
    ...
    if request.method == 'GET':
        sql = "select id as 'key',instance_name,instance_host,instance_password,instance_status,network,cpu_size,disk_size,deadline from cloud order by instance_name"

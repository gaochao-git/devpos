...
def execute_submit_sql_by_uuid_func(request):
    ...
    cursor = connection.cursor()
    try:
        cmd = "python3.5 /Users/wutianhong/Desktop/git_repo/gaochao/devpos/django_backend/scripts/inception_execute.py '{}' {} {} {} '{}' &".format(submit_sql_uuid, inception_backup, inception_check_ignore_warning, inception_execute_ignore_error, split_sql_file_path)
